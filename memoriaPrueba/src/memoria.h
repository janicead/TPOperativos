...
void realizarHandshakeAlServer(int, char*, char*);
void aceptarConexiones(int);

//FUNCIONES HACIA MDJ
char *validarArchivo(int socketReceptor, int protocoloID, char *path);
char *crearArchivo(int socketReceptor, int protocoloID, char *path, int cantidadDeLineas);
char *obtenerDatos(int socketReceptor, int protocoloID, char *path, int offset, int size);
void guardarDatos(int socketReceptor, int protocoloID, char *path, int offset, int size, char *buffer);
char *realizarFlush(int socketReceptor, char *path, int tranferSize, char *todoElArchivo);
char *eliminarArchivo(int socketReceptor, int protocoloID, char *path);
